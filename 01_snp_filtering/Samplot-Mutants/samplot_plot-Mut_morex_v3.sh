...
OUT_DIR="/panfs/roc/groups/9/morrellp/shared/Projects/Mutant_Barley/exploration_morex_v3/png_samplot_mut10xGenomics"
# Sample IDs, one per variable
# Must be in the same order as the BAM files
SAMPLE_ID1="M20_10xGenomics_morex_v3"
SAMPLE_ID2="M29_10xGenomics_morex_v3"
# BAM files, one per variable
BAM1="/panfs/roc/groups/9/morrellp/shared/Projects/Mutant_Barley/longranger_morex_v3/M20-2-2/outs/M20-2-2_phased_possorted_bam.bam"
BAM2="/panfs/roc/groups/9/morrellp/shared/Projects/Mutant_Barley/longranger_morex_v3/M29-2-2/outs/M29-2-2_phased_possorted_bam.bam"
...
REGION1="/panfs/roc/groups/9/morrellp/shared/Projects/Mutant_Barley/exploration_morex_v3/SNPs_M20_M29_10xGenomics_morex_v3_merged.bed"
...
if [ "${total_lines}" -gt 50000 ]; then
    ...
    parallel --verbose run_samplot "${REGIONS}" "${OUT_DIR}/${CURR_VAR_TYPE}" "${ANNOTATE1}" "${ANNOTATE2}" "${CURR_VAR_TYPE}" {} ${SAMPLE_ID1} ${SAMPLE_ID2} ${BAM1} ${BAM2} ::: "${bed_arr_batch2[@]}"
else

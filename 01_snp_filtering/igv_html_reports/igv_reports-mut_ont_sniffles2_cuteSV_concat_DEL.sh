...
VCF1="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/nanopore_mutated_barley/concat_sniffles2_cuteSV/mut_ont_cutesv_and_sniffles2.concat.DEL.vcf"
# Reference fasta
...
OUT_PREFIX="sniffles2_cutesv_concat-mut_ont.private.callable.noRefDiffs.DEL"

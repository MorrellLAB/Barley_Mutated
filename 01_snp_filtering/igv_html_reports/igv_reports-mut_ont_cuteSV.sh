...
VCF1="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/nanopore_mutated_barley/cutesv_calls/filtered/mut_ont_cutesv.private.callable.noRefDiffs.INDELs.vcf"
# Reference fasta
...
OUT_PREFIX="cuteSV-mut_ont_cutesv.private.callable.noRefDiffs.INDELs"

...
VCF1="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/nanopore_mutated_barley/overlap_sniffles2_and_cuteSV/mut_ont_cuteSV_intersect_sniffles2.vcf"
# Reference fasta
...
OUT_PREFIX="cuteSV_sniffles2_overlaps-mut_ont.private.callable.noRefDiffs.INDELs"

...
# VCF files
VCF="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/pacbio_morex/pacbio_morex_v3/Morex_pacbio_90_renamed.vcf"
OUT_DIR="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/pacbio_morex/pacbio_morex_v3/filtered"
# Output file prefix
...
UNCALLABLE="/panfs/jay/groups/9/morrellp/shared/Projects/Mutant_Barley/uncallable_regions/morex_v3_combined_uncallable.nochrUn.bed"
...
# Index vcf
bcftools index ${OUT_DIR}/${OUT_PREFIX}.noHomRef.geSup${MIN_SUPPORT}.vcf.gz

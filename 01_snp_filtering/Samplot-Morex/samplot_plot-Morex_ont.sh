...
source activate /panfs/jay/groups/9/morrellp/liux1299/.conda/envs/my_samplot_env
module load parallel/20210822

# User provided input arguments
OUT_DIR="/panfs/jay/groups/9/morrellp/shared/Projects/Mutant_Barley/samplot-morex_ont"
# Important regions
REGIONS_DEL="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/nanopore_morex/Morex_ont_partsRefv3/filtered/morex_ont.noHomRef.geSup5.callable.DEL.bed.gz"
REGIONS_INS="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/nanopore_morex/Morex_ont_partsRefv3/filtered/morex_ont.noHomRef.geSup5.callable.INS.bed.gz"
...
# Uncallable regions
UNCALLABLE="/panfs/jay/groups/9/morrellp/shared/Projects/Mutant_Barley/uncallable_regions/morex_v3_combined_uncallable.low_complexity.nochrUn.bed.gz"

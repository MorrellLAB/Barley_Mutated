...
OUT_DIR="/panfs/jay/groups/9/morrellp/shared/Projects/Mutant_Barley/samplot-morex_pacbio"
# VCF file
# All of the following VCFs have excluded HOM REF sites
#VCF="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/pacbio_morex/pacbio_morex_v3/filtered/morex_pacbio.noHomRef.geSup3.callable.INDELs.vcf.gz"
# Important regions
REGIONS_DEL="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/pacbio_morex/pacbio_morex_v3/filtered/morex_pacbio.noHomRef.geSup5.callable.DEL.bed.gz"
REGIONS_INS="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/pacbio_morex/pacbio_morex_v3/filtered/morex_pacbio.noHomRef.geSup5.callable.INS.bed.gz"
# BAM file (requires @RG header lines)
BAM="/panfs/jay/groups/9/morrellp/shared/Datasets/Alignments/pacbio_morex/pacbio_morex_v3/Morex_pacbio_90_wRG.bam"
SAMPLE_NAME="morex_pacbio"

# BED file for annotations
# Uncallable regions
UNCALLABLE="/panfs/jay/groups/9/morrellp/shared/Projects/Mutant_Barley/uncallable_regions/morex_v3_combined_uncallable.nochrUn.bed.gz"

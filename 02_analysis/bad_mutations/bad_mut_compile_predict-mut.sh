...
PREDICT_DIR_LIST="/scratch.global/liux1299/bad_mutations/predict_output_mut_lines/predict_out_dir_list.txt"
...
LONG_SUBS_FILE="/panfs/jay/groups/9/morrellp/shared/Projects/Mutant_Barley/results/bad_mutations/vep_to_subs-mut/per_transcript_subs-mut_SNPs_private/mut8_and_3mut10xGenomics.SNPs.private_long_subs.txt"
# Project name will be used as prefix for final combined report
PROJECT="mut_snps_private"

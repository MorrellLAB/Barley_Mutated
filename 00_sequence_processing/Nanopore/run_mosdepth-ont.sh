...
BAM_LIST="/panfs/roc/groups/9/morrellp/shared/Datasets/Alignments/nanopore_morex/Morex_ont_partsRefv3/ont_bam_list.txt"
...
function run_mosdepth() {
    ...
    set -x # For debugging
    mosdepth --by ${win_size} --threads 4 --fast-mode --fasta ${ref} --no-per-base ${sample_prefix} ${bam_file}
}
